...
git init
git add .
git commit -m "$USER - rebuilding gh-pages-slides $(date)"
git remote add origin $ORIGIN_URL
git push --force origin master:gh-pages-slides
cd $OLD
rm -rf $BUILD_DIR
...
echo
echo "***********************************************************"
echo created gh-pages-slides under following url
